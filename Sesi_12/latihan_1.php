...
<body>
    ...
    <script>
        ...
        bacadta.onload = function(){
            ...
            let tx = '<table><tr><td>#</td><td>NAMA LENGKAP</td><td>EMAIL</td><td>USER NAME</td><td><a href="latihan_1.baru.html">Tambah</a></td></tr>';
            let no = 1;
            for(let cx=0; cx<jdta.isi.length; cx++){
               ...
               tx += '<a href="latih01-dele.html?id='+jdta.isi[cx][3]+'>Hapus</a>';
               tx += '</td>';
               tx += '</tr>';
               no++;
            }
